...
TASK_REGISTRY = {
    "TaxBen_TaxRecite": TaxBen.TaxRecite,
    "TaxBen_TaxTopic": TaxBen.TaxTopic,
    "TaxBen_TaxSum": TaxBen.TaxSum,
    "TaxBen_TaxRead": TaxBen.TaxRead,
    "TaxBen_TaxCalc": TaxBen.TaxCalc,
    "TaxBen_TaxSCQ": TaxBen.TaxSCQ,
    "TaxBen_TaxMCQ": TaxBen.TaxMCQ,
    "TaxBen_TaxQA": TaxBen.TaxQA,
    "TaxBen_TaxBoard": TaxBen.TaxBoard,
}
